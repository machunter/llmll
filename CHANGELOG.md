...
- **Tests: 767 Haskell + 58 Python** (F-GATE-1 +3 INV-P9–P11; LT-INV +28; 4 additional tests from F-005 `WarnVacuousOverOmega` fix, commit `0b5b249`, account for the gap between the F-006/F-005 entry count of 712 and the 716 pre-LT-INV baseline).
