...
- **Spec-drift fix:** `§5.3.5` non-QF-LIA alias-intro-obligation row corrected — a refinement-typed binding emits **no** runtime assertion (`augmentContractPre` is verifier-local), contra the prior "runtime assertion" Fallback text.
