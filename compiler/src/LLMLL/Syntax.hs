...
isCoreBodySyntactic expr = case expr of
  ...
  where
    ...
    isNullaryCtorArm (PConstructor _ []) = True
    isNullaryCtorArm _                   = False
    isMixedNullaryPayloadArms [p1, p2] =
      (isNullaryCtorArm p1 && isPayloadCtorArm p2)
        || (isPayloadCtorArm p1 && isNullaryCtorArm p2)
    isMixedNullaryPayloadArms _ = False
