...
| `docs/design/core-shell-inversion-direction.md` | All of LT-INV + LT-CDP + LT-PPR ship | ~~Fold into lead proposal's `## Background` (per M2 case 3), then archive~~ **DONE (2026-06-12)** — folded into [`core-shell-inversion-proposal.md`](design/core-shell-inversion-proposal.md) `## Background`; archived to `shipped-design-specs/` |
