...
|---|---|---|---|
| [`version_gate.sh`](../../scripts/version_gate.sh) | 58 | yes, 2 jobs | **PORTED**, `tool_state: oracle`, TOOL-RFC-001. **STAYS `oracle` by decision 2026-08-17**: §4 condition 2 fails in the `publish` job |
...
| [`build_smoke.sh`](../../scripts/build_smoke.sh) | 381 | yes | **PORTED**, `tool_state: oracle`, TOOL-RFC-006. It runs the other five ports. **STAYS `oracle` by decision 2026-08-17**, on defect yield |
