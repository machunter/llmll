...
| **26** | Reconcile `INDEX.md` and the DRIVER-LL roadmap row to **Rev 11** | documentation-lead | **PENDING.** Rides with task 22's ceremony; INDEX labels are doc-lead's slot |
