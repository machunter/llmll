...
Read this first, then [`driver-ll-phase4-proposal.md`](driver-ll-phase4-proposal.md) (**Rev 13**,
...
**Rev 13**: Rev 10, plus the amendments the port earned, plus Rev 12's correction of one of them,
plus **Rev 13 closing the §3.6 census**. No revision changed what 4c does.
...
| 20 | **Re-census proposal §3.6's table** | experiment-lead | **done** (`8881ba4`, `ba4cc0a`, restated as Rev 13). Computed by a durable instrument, not derived by hand: the table is **replaced**, its five rows being undecidable on their own terms; disagreements are **thirteen, not one**; and §3.6.1's "no census would have found this" is **refuted** by a three-value lattice that found twelve instances |
