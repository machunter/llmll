...
| [core-shell-inversion-proposal.md](core-shell-inversion-proposal.md) | LT-INV: invert source grammar; `def` strict-core; `def-shell` permissive marked | **Settled (Rev 3)** — §8 gate PASS definitive (EL-5, PM-006, 2026-05-30); CE-3 `GrammarCoreInversion` default confirmed; `examples/*` migration pending |
