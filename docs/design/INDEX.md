...
| [driver-ll-phase4-proposal.md](driver-ll-phase4-proposal.md) | Eleven agent-delegated stages, the serial wave, and two checkable oracles | **Rev 10, SETTLED**: sub-phases 4a (`2b82464`, v0.14.85) and 4b (`ba2f93d`, v0.14.87) shipped and the phase runs at 4c, 4c-4f open; Rev 10 replaced 4c's acceptance clause after measuring it unsatisfiable both ways |
