...
| [cross-module-composition-finding.md](cross-module-composition-finding.md) | XMOD-COMP: cross-module verified composition was a 5-layer gap | **Goal reached (v0.14.17)** — layer 4 closed by XMOD-AG; sole residual (confirmed) is the checkout `consumed_guarantees` brief dropping imported callees (`Main.hs:1951` same-file cenv) — completeness/DX, not soundness |
