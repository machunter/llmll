...
| [data-scope-lever-a-arrays-proposal.md](data-scope-lever-a-arrays-proposal.md) | Lever A: QF array theory for `bytes[n]`/`map[k,v]` — index-in-bounds + get-after-put in `Σ_auto` | **Rev 0** — awaiting professor review |
