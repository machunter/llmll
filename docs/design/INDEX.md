...
| [cross-module-composition-finding.md](cross-module-composition-finding.md) | XMOD-COMP: cross-module verified composition was a 5-layer gap | **Goal reached (v0.14.17)** — layer 4 (body-VC emission) closed by XMOD-AG; sole residual is layer 5 (`callee_tier` obligation-report keying) |
