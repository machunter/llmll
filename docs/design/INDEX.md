...
| [core-shell-inversion-proposal.md](core-shell-inversion-proposal.md) | LT-INV: invert source grammar; `def` strict-core; `def-shell` permissive marked | **Settled (Rev 3)** — §8 gate adjudicated (rollback path 1, definitive 2026-05-29); redesigned gate experiment unblocked (F-GATE-8 `f62a38b`) |
