...
| [data-scope-lever-a-arrays-proposal.md](data-scope-lever-a-arrays-proposal.md) | Lever A: QF array theory for `bytes[n]`/`map[k,v]` — index-in-bounds + get-after-put in `Σ_auto` | **Rev 1** — review folded (F1–F3 gated revisions in; int-only keys v1) — ready for compiler-engineer feasibility read (A0/A1) |
