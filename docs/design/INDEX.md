...
| [finding-arg-position-false-safe.md](finding-arg-position-false-safe.md) | A `bytes[n]` length asserted from an unvalidated declaration proved an out-of-bounds read safe | **FIXED v0.14.73** (SAFE-ARG / WILD-ASSUME); affected v0.14.34..v0.14.72; `map[k,bool]` arm deferred |
