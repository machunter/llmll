...
| [data-scope-extension.md](data-scope-extension.md) | Didactic multi-post: the data verification boundary (`Σ_auto`) and the array/dependent-length/induction extension levers | **Design / roadmap** — Lever B/C forward-looking; **current-state posts 1–5 superseded** — the map/array boundary they teach shipped (Lever A, `LLMLL.md §5.3.3`); body rewrite owed to language-team |
