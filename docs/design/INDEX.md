...
| [spec-from-rfc-pipeline.md](spec-from-rfc-pipeline.md) | R3 pipeline: RFC clauses → classified, `:source`-traced, adequacy-checked contracts | **Active — Rev 0, §4 evaluation EXECUTED** (RFC 1982, all six criteria pass — `examples/rfc1982_serial/`); remaining: fold F-1982-3/-4/-5 doc revisions |
