...
| [spec-from-rfc-pipeline.md](spec-from-rfc-pipeline.md) | R3 pipeline: RFC clauses → classified, `:source`-traced, adequacy-checked contracts | **Active — Rev 0**; remaining: §4 evaluation run (one unseen RFC, experiment-lead) |
