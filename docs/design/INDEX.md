...
| [core-shell-inversion-proposal.md](core-shell-inversion-proposal.md) | LT-INV: invert source grammar; `def` strict-core; `def-shell` permissive marked | **Settled (Rev 3)** — §8 gate outcome recorded; rollback path (1) adopted (2026-05-29); grammar default deferred; redesigned gate experiment pending post-F-GATE-8 |
| [contract-discriminative-power-proposal.md](contract-discriminative-power-proposal.md) | LT-CDP: contract DP as v0.11 first-class evidence axis; two-axis assurance | **Settled (Rev 5)** — CE follow-up complete (commit `3af3c06`); §8 Outcome 0 recorded; pending doc-lead promotion |
| [proof-required-predicate-carrier-proposal.md](proof-required-predicate-carrier-proposal.md) | LT-PPR: predicate-carrying `?proof-required`; def-shell only; runtime-assertion fallback | **Settled (Rev 2)** — engineer build shipped (`3391713`); schema doc pass complete |
