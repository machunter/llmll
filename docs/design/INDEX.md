...
| [data-scope-lever-a-arrays-proposal.md](data-scope-lever-a-arrays-proposal.md) | Lever A: QF array theory for `bytes[n]`/`map[k,v]` — index-in-bounds + get-after-put in `Σ_auto` | **Rev 0** — professor-reviewed, awaiting language-team Rev 1 |
| [data-scope-lever-a-arrays-review.md](data-scope-lever-a-arrays-review.md) | Professor review of Lever A Rev 0 — proceed-with-revisions; F1–F3 gate Rev 1 (refutation-completeness discipline), F4 gates A2; Q1/Q2 resolved as proposed | Review — awaiting language-team Rev 1 |
