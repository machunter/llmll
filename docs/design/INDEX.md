...
| [cascading-refinement-proposal.md](cascading-refinement-proposal.md) | Agent-driven recursive hole decomposition: `refine` op + growing tree + CDP/feasibility gates + Option-3 cycles | **Rev 5 — Stages 1–3 SHIPPED v0.14.13, Stage-4 REFINE-REUSE SHIPPED v0.14.29, feasibility (no-miracle) gate SHIPPED v0.14.52**; Option-3 cycles reconciled to REC-PARTIAL-MARK's `termination_unverified` marker (2026-07-10); decomposition-trust meet open |
