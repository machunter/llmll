...
| [expiring-intentional-proposal.md](expiring-intentional-proposal.md) | Expiring `:intentional` (Rust `#[expect]` model): W614 when the suppressed CDP diagnostic no longer fires | **BLOCKED (Rev 0.2)** — core predicate unsatisfiable (proof+empirical); reopened as language-team redesign |
