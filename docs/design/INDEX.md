...
| [driver-ll-phase4-proposal.md](driver-ll-phase4-proposal.md) | Eleven agent-delegated stages, the serial wave, and two checkable oracles | **Rev 8, SETTLED**: sub-phase 4a shipped (`2b82464`, v0.14.85) and the phase runs at 4b, 4b-4f open; `FS-COPY-1` shipped v0.14.84 and `FS-ENCODING-1` completed at v0.14.86 |
