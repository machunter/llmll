...
- **`CRYPTO-2`** — open, and **ROUTED 2026-08-18**: an Active-Items roadmap row
  ...
  unrouted. *(Note 2026-09-23: `REPORT-GATE-1` was routed to its own roadmap
  row on 2026-09-07 and shipped in v0.25.3 on 2026-09-23. `CRYPTO-2` itself
  closed 2026-09-07. This leaves `INT-3` as the only open item.)*
