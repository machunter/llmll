...
| **REF-META-2..5** (solver-completeness, erasure, predicate WF, typing judgment) | **REF-META-2/3/4 promoted; REF-META-5 open** | REF-META-2 (Σ_auto solver-completeness, `LLMLL.md §5.3.3`) + REF-META-3 (predicate WF, `§3.4.4`) promoted 2026-06-12; REF-META-4 (erasure theorem, `§3.4.5`) promoted 2026-06-13 ([`ref-meta-4-erasure-proposal.md`](design/ref-meta-4-erasure-proposal.md), Settled Rev 3). **REF-META-5** (full bidirectional judgment) now unblocked — LT draft → doc-lead promotion to `§3.4/§5`. Sequenced in [`docs/design/v0.12-direction.md §1`](design/v0.12-direction.md). |
