...
| **LT-INV** (core/shell grammar inversion) | **Settled (Rev 2) — review folded** | LT proposal at [`docs/design/core-shell-inversion-proposal.md`](design/core-shell-inversion-proposal.md) settled Rev 2 (commit `5f31580`, 2026-05-25) incorporating seven gaps + two author-question answers from professor review; review folded as §"Appendix — Professor review log" (commit `f1ef0c0`); standalone archived to [`docs/archive/professor-reviews/core-shell-inversion-review.md`](../docs/archive/professor-reviews/core-shell-inversion-review.md). Engineer build behind `--grammar=core-inversion` opt-in flag; gated on §8 empirical validation gate. Subsumes STRICT-CORE-1 sub-item. Cross-proposal shipping under gate outcomes per [`v0.11-cross-proposal-rollback-discipline.md`](design/v0.11-cross-proposal-rollback-discipline.md). |
| **LT-CDP** (contract discriminative power evidence axis) | **Settled (Rev 2) — review folded** | LT proposal at [`docs/design/contract-discriminative-power-proposal.md`](design/contract-discriminative-power-proposal.md) settled Rev 2 (commit `5f31580`, 2026-05-25) incorporating seven gaps + two author-question answers from professor review; review folded as §"Appendix — Professor review log" (commit `f1ef0c0`); standalone archived to [`docs/archive/professor-reviews/contract-discriminative-power-review.md`](../docs/archive/professor-reviews/contract-discriminative-power-review.md). Engineer build sequenced after LT-INV per §2; CDP-0 publishes v0.10-baseline DP report before LT-INV §8 gate runs. Subsumes DP-FORM-1 + TRUST-DP-1 sub-items. Cross-proposal shipping under gate outcomes per [`v0.11-cross-proposal-rollback-discipline.md`](design/v0.11-cross-proposal-rollback-discipline.md). |
