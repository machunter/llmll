...
| **REF-META-2..5** (solver-completeness, erasure, predicate WF, typing judgment) | **P2-P3 — open** | LT drafts (REF-META-2 and REF-META-3 parallel, REF-META-4 after REF-META-3, REF-META-5 last) → doc-lead promotion to `LLMLL.md §3.4/§5.3.3`. Sequenced in [`docs/design/v0.12-direction.md §1`](design/v0.12-direction.md). |
