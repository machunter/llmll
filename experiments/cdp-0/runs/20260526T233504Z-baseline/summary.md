...
- **Timestamp (UTC):** 20260526T233504Z
...
- Contracted functions across corpus: **37**
- Defined-score functions: **4** (10.8%)
- Midrange (0 < DP < 1) functions: **0** (0.0% of defined)

### Score distribution (defined scores only)

- mean: **0.000**, median: **0.000**
- min: 0.000, p10: 0.000, p50: 0.000, p90: 0.000, max: 0.000

### Warning counts

- `candidates-empty-under-limit`: 5
- `identity-satisfies-post`: 4
- `not-requested`: 22
- `spec-inconsistent`: 6
